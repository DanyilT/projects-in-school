...
//1
        File file1 = new File("C:/dataJAVA/input.txt");
        if(!file1.exists()) file1.createNewFile();
        System.out.println("File \"input.txt\" create in \"C:/dataJAVA\"");
//2
...
//4
        ...
        pw.println("My name...");
        pw.close();
        System.out.println("File \"input.txt\" length = " + file1.length());
...
//5
        ...
        System.out.println("File \"inputNew.txt\" to move in another folder and rename to the \"input.txt\"");
        if(fileChooser.showSaveDialog(null) == JFileChooser.APPROVE_OPTION){
            file2.renameTo( new File(fileChooser.getSelectedFile().getAbsolutePath() + "/" + file1.getName()));
        }
        file2 = new File("C:/dataJAVA/javaNew/input.txt");
//6
        file2.delete();
        folder.delete();
